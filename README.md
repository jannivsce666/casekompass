# CaseKompass – Einfache Website

Diese kleine, mobile-first Website ist für den lokalen Anbieter "CaseKompass" im Raum Bolheim & Heidenheim erstellt. Sie nutzt nur HTML, CSS und JavaScript (ohne Frameworks).
